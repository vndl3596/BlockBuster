...
public class MovieEvaluateMap {
    ...
    public MovieEvaluate dTOToMovieEvaluate(MovieEvaluateDTO movieEvaluateDTO) {
        return new MovieEvaluate(
                new MovieEvaluateKey(movieEvaluateDTO.getAccountDTO().getId(),
                        movieEvaluateDTO.getMovieDetailDTO().getId()),
                accountRepository.getById(movieEvaluateDTO.getAccountDTO().getId()),
                movieDetailRepository.getById( movieEvaluateDTO.getMovieDetailDTO().getId()),
