...
public class SendMailServiceImpl implements SendMailService {
    ...
    public void contact(String name, String email, String content) {
        try {
            ...
            dataMail.setTo("vonguyenduylong3596@gmail.com");
            dataMail.setSubject(Const.SEND_MAIL_SUBJECT.CLIENT_CONTACT);
            ...
            mailService.sendHtmlMail(dataMail, Const.TEMPLATE_FILE_NAME.CLIENT_CONTACT);
        } catch (MessagingException exp) {
            exp.printStackTrace();
        }
    }
