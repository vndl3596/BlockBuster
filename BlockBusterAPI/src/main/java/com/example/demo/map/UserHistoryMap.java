...
public class UserHistoryMap {
    ...
    public UserHistoryDTO userHistoryToDTO(UserHistory userHistory) {
        return new UserHistoryDTO(userHistory.getId(), userHistory.getUser().getId(), userHistory.getMovie().getId(), userHistory.getHistoryDate(), userHistory.getMovieTime());
    }
