...
public class MembershipBuyHistoryMap {
    ...
    public MembershipBuyHistoryDTO membershipBuyHistoryToDTO(MembershipBuyHistory membershipBuyHistory) {
        return new MembershipBuyHistoryDTO(membershipBuyHistory.getId(),
                ...
                membershipBuyHistory.getVoucher()!=null?membershipBuyHistory.getVoucher().getId():null, membershipDetailMap.membershipDetailToDTO(membershipBuyHistory.getMembershipDetailBuy())
                , accountMap.accountToDTO(membershipBuyHistory.getAccountBuy()));
    }
